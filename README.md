...
- 自动记忆不仅包含用户明确表达的长期信息，也可包含双方确认的称呼与约定、共同经历，以及桌宠明确作出的具体承诺；临时情绪、客套话、无依据的自我设定和核心人格变化不会自动保存
- 记忆书支持四章节、搜索、编辑、忘记、撤销、导出、索引重建和清空；开启来源保留后，可在单条记忆详情中查看生成它所依据的一轮用户消息与桌宠最终回复
